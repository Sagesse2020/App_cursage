...
<head>
    ...
    <title>{{ config('app.name')}}-Formulaire Fiche de suivi</title>
...
<nav class="navbar navbar-expand-lg_light">
    <div class="container">
      ...
      <li class="nav-item">
      <a class="nav-link @if(Request::route()->getName() == 'fiches_suivi.create') active @endif" aria-current="page" href="{{ route('fiches_suivi.create') }}">Enregistrer une fiche de suivi</a>
      </li>
       <li class="nav-item">
